...
| `datatypes_reference.md` | **Lookup table** of all data types, enums, and exceptions defined in the initial architecture (§E.5 / §E.6). | Check before defining a new type — Convention 1 forbids name collisions. Grouped by PMS-specific / FHIR / primitives / enums / exceptions, with a quick "do I need a new type?" checklist at the bottom. |
