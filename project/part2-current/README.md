...
| `p1_current.md` | **Living design draft** for the P1 (Performance — Data exchange with physicians) extension. Mine; edit freely. | Read when reasoning about the P1 proposal. §0 = QAS, §1–§3 = approach, §7 = seams with the teammate's Av2 work. Treat as a draft to stress-test — surface sensitivity / trade-off points the draft misses. |
...
- **P1 (Medium priority)** — mine. All P1 design work goes in `p1_current.md`.
- **Av2 (High priority)** — teammate's. Do not edit. Coordination notes live in `p1_current.md` §7 (seams).
